...
train_dataset = dataloader_SRCNN.microCT_Dataset(train_files,train_or_test = 'train',
...
# If need to generate pathes for the firs time then put true for the need_patches
test_dataset = dataloader_SRCNN.microCT_Dataset(test_files,train_or_test = 'test',
                                         HR_patch_size=patch_size,
                                         transform = None,
                                          need_patches=False)
...
#save model
def save_checkpoint(state, filename="my_SRCNN_checkpoint.pth.tar"):
